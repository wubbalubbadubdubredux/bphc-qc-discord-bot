...
@client.command()
async def taunt(ctx, *, target):
    taunts = ["YO MAMA'S SUCH A HO THAT WHO'S YOUR DADDY? IS A MULTIPLE-CHOICE QUESTION.",
              ...
              "YO ASS SO UGLY PEOPLE DRESS AS YOU FOR HALLOWEEN.",
              "YOU'RE NOT FUNNY, BUT YOUR LIFE, NOW THAT'S A JOKE.",
              "I HEARD YOUR PARENTS TOOK YOU TO A DOG SHOW AND YOU WON.",
              "I DON'T KNOW WHAT MAKES YOU SO STUPID, BUT IT REALLY WORKS!",
              "I BET YOUR BRAIN FEELS AS GOOD AS NEW, SEEING THAT YOU NEVER USE IT.",
              "YOU'RE SO DUMB, YOUR DOG TEACHES YOU TRICKS.",
              "IF MY DOG HAS A FACE AS UGLY AS YOURS, I'D SHAVE IT'S ASS AND MAKE IT WALK AROUND BACKWARDS",
              "I WOULD HAVE LIKED TO INSULT YOU, BUT WITH YOUR INTELLIGENCE YOU WOULDN'T GET OFFENDED.",
              "KEEP TALKING, SOMEDAY YOU'LL SAY SOMETHING INTELLIGENT!",
              "LEARN FROM YOUR PARENTS' MISTAKES - USE BIRTH CONTROL!",
              "THE LAST TIME I SAW A FACE LIKE YOURS I FED IT A BANANA.",
              "THE ONLY WAY YOU'LL EVER GET LAID IF YOU CRAWL UP A CHICKEN'S ASS AND WAIT",
              "A HARD-ON DOESN'T COUNT AS PERSONAL GROWTH.",
              "ANY SIMILARITY BETWEEN YOU AND A HUMAN IS PURELY COINCIDENTAL.",
              "YO MAMA IS SO UGLY THAT I TOOK HER TO THE ZOO, GUY AT THE DOOR SAID 'THANKS FOR BRINGING HER BACK.'",
              "IF I WERE TO INSULT YOU, IT WOULD BE ANIMAL ABUSE.",
              "YO MAMA IS LIKE A GOALIE - SHE ONLY CHANGES HER PADS AFTER THREE PERIODS.",
              "YO MAMA'S LIKE A SHOTGUN, ONE COCK AND SHE BLOWS.",
              "HOW MANY GENERATIONS OF INBREEDING DID IT TAKE TO MAKE YOU?",
              "IT'S BETTER TO LET SOMEONE THINK YOU ARE AN IDIOT THAN TO OPEN YOUR MOUTH AND PROVE IT.",
              "JESUS LOVES YOU, EVERYONE ELSE THINKS YOU'RE AN ASSHOLE!",
              "YOU'RE DICK IS SO SMALL, YOU BOUGHT A KEYCHAIN FLESHLIGHT.",
              "ARE YOU ACTUALLY THIS RETARDED OR DO YOU ENJOY ACTING THIS WAY?",
              ]
    await ctx.send(f"@{target}: {random.choice(taunts)}")
